...
<rss version="2.0">
    <channel>
        ...
        <%
            ...
            sql = "Select * FROM pachume WHERE pachume.groupId IN ('00000000-0000-0000-0000-000000000000') ORDER BY pachume.pachumeId DESC LIMIT 20";
        ...
        <item>
            ...
            <description><![CDATA[<AUTHOR><%=GetScreenName.run(pachume_userId) %></AUTHOR><IMAGE><%=GetPachumeImageLocation.run(pachume_userId) %></IMAGE>]]>By <%= pachume_screenName%> <%= GetPacumeLocation.run(pachumeId)%> | <%= GetTime.run("pachume", "pachumeId", pachumeId)%></description>
